...
public class App {
	public static void main(String[] args) {
		...
		// student Save-create
		/*
		 * Student st = new Student(); st.setName("Ibraheem"); st.setAddress("Lucknow");
		 * st.setCollegeName("Kaif"); st.setEmaail("ibraheem@gmail.com");
		 * 
		 * Student st2 = new Student(); st2.setName("Mohad Rehan");
		 * st2.setAddress("Delhi"); st2.setCollegeName("LU");
		 * st2.setEmaail("rehan@gmail.com");
		 * 
...
//		  Student st = session.get(Student.class, 3);
		...
		//update data
		/*
		 * Student st=session.get(Student.class, 1); st.setName("Mohd Kaif");
		 * st.setAddress("SakiNaka"); st.setCollegeName("Integral Uni");
		 * st.setEmaail("kaif@gmail.com"); Transaction tx = session.beginTransaction();
